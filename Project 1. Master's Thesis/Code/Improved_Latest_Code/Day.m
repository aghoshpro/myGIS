...
%plot(meanSigmaScreened12,alts12,'linewidth',2,'color','red')
hold on
plot(meanSigma1064_BScreened13,alts13,'linewidth',2,'color','red','linestyle','--')
hold on
plot(meanSigma1064_BScreened14,alts14,'linewidth',2,'color','blue','linestyle','--')
hold on
plot(meanSigma1064_BScreened15,alts15,'linewidth',2,'color','green','linestyle','--')
hold on
plot(meanSigma1064_BScreened16,alts16,'linewidth',2,'color','[0.9 0.7 0]','linestyle','--')%Gold
hold on
plot(meanSigma1064_BScreened17,alts17,'linewidth',2,'color','cyan','linestyle','--')
hold on
