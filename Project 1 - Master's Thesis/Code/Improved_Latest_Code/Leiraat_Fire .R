...
setwd("C://Users//ARKA GHOSH//Desktop//PHD//Stockholm University//Interview//MODIS_Aqua_Land//Leiraat//") # same folder as the ZIP-File
...
Cairo(file="GRID_Leiraat_Terra_Best.png",
      type="png",
      units="px",
      bg = "white",
      width=2400,
...
for (i in 1:length(t1)) {
  ...
  plot(r3,col=brewer.pal(7,"YlOrRd"),main=paste(date,""),col.axis= "black",asp = 1,cex.main = 3,cex.axis = 2,interpolate = TRUE,useRaster = TRUE, legend = FALSE)
...
dev.off()
write.csv(a,"Aqua_Leiraat_Land.csv", row.names = FALSE, col.names = FALSE)
